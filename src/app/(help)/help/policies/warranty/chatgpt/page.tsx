...
export const metadata: Metadata = {
    title: 'Chính sách bảo hành ChatGPT Plus | TAIKHOANXIN.COM',
    description: 'Chính sách bảo hành tài khoản ChatGPT Plus',
};

export default function ChatGPTWarrantyPage() {
    return (
        <div className={styles.helpContent}>
            <h1>Chính sách bảo hành - ChatGPT Plus</h1>
            
            <p>
                Chính sách bảo hành chi tiết cho tài khoản ChatGPT Plus tại TAIKHOANXIN.COM.
            </p>
            ...
            <div className={styles.productCategories}>
                <div className={styles.category}>
                    ...
                    <p>Tài khoản bị khóa, sai mật khẩu do lỗi từ OpenAI</p>
                </div>
                ...
                <div className={styles.category}>
                    <h4>🚫 Mất tính năng Plus</h4>
                    <p>Không dùng được GPT-5, GPT-5.1, DALL-E 3, Canvas...</p>
                </div>
            ...
            <div className={styles.warningBox}>
                <ul>
                    ...
                    <li>Vi phạm điều khoản OpenAI (spam, nội dung vi phạm...)</li>
                    <li>Sử dụng VPN không ổn định, đổi IP liên tục</li>

...
export default function YoutubeTVPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // const response = await fetch('/api/tools/youtube-tv', {
            //     method: 'POST',
            //     headers: { 'Content-Type': 'application/json' },
            //     body: JSON.stringify({ orderCode, email, tvCode }),
            // });
            ...
            <div className={cx('page-container')}>
                ...
                <div className={cx('steps-section')}>
                    <div className={cx('step-card')}>
                        ...
                        <p className={cx('step-description')}>
                            Truy cập{' '}
                            <a href="https://taikhoanxin.com/account/orders" target="_blank" rel="noopener noreferrer" className={cx('step-link')}>
                ...
                <div className={cx('form-card')}>
                    ...
                    <form onSubmit={handleSubmit} className={cx('form')} noValidate>
                        ...
                        <div className={cx('form-group')}>
                            <label className={cx('form-label')}>Mã trên TV</label>
                            <input
                                type="text"
                                className={cx('form-input', { 'has-error': errors.tvCode })}
                                placeholder="Nhập mã hiển thị trên TV"
                                value={tvCode}

...
import { getProductById, detectProductGenre } from '@/services/productService';
...
const getRecentlyViewedProducts = (): FeaturedProduct[] => {
...
export default function ViewedProductsPage() {
    ...
    const [recentlyViewed, setRecentlyViewed] = useState<FeaturedProduct[]>([]);

                ...
                <div className={cx('content-section')}>
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Bằng việc truy cập và sử dụng trang web Tài Khoản Xịn, bạn đồng ý tuân thủ và bị ràng buộc 
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <ul className={cx('content-list')}>
                                <li><strong>"Chúng tôi", "Công ty":</strong> Chỉ Tài Khoản Xịn và các đối tác liên quan</li>
                                <li><strong>"Bạn", "Người dùng", "Khách hàng":</strong> Chỉ cá nhân hoặc tổ chức sử dụng dịch vụ của chúng tôi</li>
                                <li><strong>"Dịch vụ":</strong> Tất cả các dịch vụ được cung cấp trên trang web của chúng tôi</li>
                                <li><strong>"Nội dung":</strong> Tất cả thông tin, văn bản, hình ảnh, video và các tài liệu khác trên trang web</li>
                            </ul>
                        </div>
                    </section>
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            ...
                            <p>
                                Để sử dụng một số tính năng của dịch vụ, bạn có thể cần đăng ký tài khoản. Bạn đồng ý:
                            </p>
                            <ul className={cx('content-list')}>
                                ...
                                <li>Thông báo ngay lập tức nếu phát hiện sử dụng trái phép tài khoản</li>
                            </ul>
                            ...
                            <ul className={cx('content-list')}>
                                ...
                                <li>Sử dụng dịch vụ để gây hại, quấy rối hoặc lừa đảo người khác</li>
                            </ul>
                        </div>
                    </section>
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            ...
                            <p>
                                Khi bạn đặt hàng, bạn đồng ý mua sản phẩm theo giá và điều kiện được nêu tại thời điểm đặt hàng. 
                                Chúng tôi bảo lưu quyền từ chối hoặc hủy đơn hàng vì bất kỳ lý do nào.
                            </p>

                            <h3 className={cx('subsection-title')}>4.2. Thanh Toán</h3>
                            <p>
                                Bạn đồng ý thanh toán đầy đủ giá trị đơn hàng khi đặt hàng. Chúng tôi chấp nhận thanh toán qua 
                                các phương thức được liệt kê trên trang web. Tất cả giao dịch được xử lý một cách an toàn.
                            </p>

                            <h3 className={cx('subsection-title')}>4.3. Giao Hàng</h3>
                            <p>
                                Sau khi thanh toán thành công, chúng tôi sẽ giao tài khoản cho bạn trong thời gian sớm nhất có thể. 
                                Thời gian giao hàng có thể thay đổi tùy thuộc vào từng sản phẩm.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Chính sách hoàn tiền và đổi trả được áp dụng theo từng trường hợp cụ thể. Vui lòng liên hệ với 
                                chúng tôi để biết thêm chi tiết về chính sách hoàn tiền cho sản phẩm bạn đã mua.
                            </p>
                            <p>
                                <strong>Lưu ý:</strong> Do tính chất đặc thù của sản phẩm số, một số sản phẩm có thể không được 
                                hoàn tiền sau khi đã giao hàng thành công.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Tất cả nội dung trên trang web, bao gồm nhưng không giới hạn ở văn bản, đồ họa, logo, hình ảnh, 
                                video và phần mềm, là tài sản của Tài Khoản Xịn hoặc được cấp phép sử dụng. Bạn không được sao chép, 
                                sửa đổi, phân phối hoặc sử dụng nội dung này mà không có sự đồng ý bằng văn bản của chúng tôi.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Chúng tôi cung cấp dịch vụ "như hiện tại" và "như có sẵn". Chúng tôi không đảm bảo rằng:
                            </p>
                            <ul className={cx('content-list')}>
                            ...
                            <p>
                                Chúng tôi không chịu trách nhiệm cho bất kỳ thiệt hại nào phát sinh từ việc sử dụng hoặc không thể 
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Trong phạm vi tối đa được pháp luật cho phép, Tài Khoản Xịn sẽ không chịu trách nhiệm cho bất kỳ 
                                thiệt hại gián tiếp, ngẫu nhiên, đặc biệt, hậu quả hoặc thiệt hại phát sinh từ việc sử dụng hoặc 
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Chúng tôi bảo lưu quyền sửa đổi các điều khoản này bất cứ lúc nào. Các thay đổi sẽ có hiệu lực 
                                ngay sau khi được đăng trên trang web. Việc bạn tiếp tục sử dụng dịch vụ sau khi các thay đổi 
                                có hiệu lực được coi là bạn đã chấp nhận các thay đổi đó.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Các điều khoản này được điều chỉnh và giải thích theo pháp luật Việt Nam. Bất kỳ tranh chấp nào 
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            ...
                            <ul className={cx('contact-list')}>
                                <li><strong>Email:</strong> <a href="mailto:legal@taikhoanxin.com">legal@taikhoanxin.com</a></li>

...
import styles from '@/app/(user)/privacy/page.module.scss';
                ...
                <div className={cx('content-section')}>
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Tài Khoản Xịn (&quot;chúng tôi&quot;, &quot;của chúng tôi&quot; hoặc
                                &quot;công ty&quot;) cam kết bảo vệ và tôn trọng quyền riêng tư của bạn.
                                Chính sách bảo mật này giải thích cách chúng tôi thu thập, sử dụng, tiết
                                lộ và bảo vệ thông tin cá nhân của bạn khi bạn sử dụng trang web của
                                chúng tôi.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            ...
                            <ul className={cx('content-list')}>
                                <li>
                                    <strong>Nhà cung cấp dịch vụ:</strong> Các bên thứ ba giúp chúng tôi
                                    vận hành trang web và cung cấp dịch vụ
                                </li>
                                <li>
                                    <strong>Đối tác thanh toán:</strong> Để xử lý thanh toán của bạn
                                </li>
                                <li>
                                ...
                                <li>
                                    <strong>Với sự đồng ý của bạn:</strong> Trong các trường hợp khác
                                    khi bạn đã đồng ý
                                </li>
                            </ul>
                        </div>
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Chúng tôi sử dụng các biện pháp bảo mật kỹ thuật và tổ chức phù hợp để
                                bảo vệ thông tin cá nhân của bạn khỏi truy cập, sử dụng, tiết lộ, thay
                                đổi hoặc phá hủy trái phép. Tuy nhiên, không có phương thức truyền tải
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Chúng tôi sử dụng cookie và công nghệ theo dõi tương tự để cải thiện trải
                                nghiệm của bạn, phân tích cách bạn sử dụng trang web và hỗ trợ các nỗ lực
                                marketing của chúng tôi. Bạn có thể kiểm soát cookie thông qua cài đặt
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            <p>
                                Chúng tôi có thể cập nhật chính sách bảo mật này theo thời gian. Chúng tôi
                                sẽ thông báo cho bạn về bất kỳ thay đổi nào bằng cách đăng chính sách mới
                                trên trang này và cập nhật ngày &quot;Cập nhật lần cuối&quot; ở cuối
                                trang này.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className={cx('content-block')}>
                        ...
                        <div className={cx('section-content')}>
                            ...
                            <ul className={cx('contact-list')}>
                                <li>
                                    <strong>Email:</strong>{' '}
                                    <a href="mailto:privacy@taikhoanxin.com">
                                        privacy@taikhoanxin.com
                                    </a>
                                </li>
                                <li>

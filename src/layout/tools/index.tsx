...
import styles from '@/app/(tools)/tools/page.module.scss';
import { KeyIcon, PlayIcon, PaperPlaneIcon, FileTextIcon } from '@/components/Icons';
...
export default function ToolsHomeLayout() {
    return (
